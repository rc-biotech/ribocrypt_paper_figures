...
source("~/livemount/shared_scripts/ribocrypt_paper_figures/ORF_prediction_subsampling/NTE_CTE_INTRONS/CTE_subset.R")
source("~/livemount/shared_scripts/ribocrypt_paper_figures/ORF_prediction_subsampling/NTE_CTE_INTRONS/CTE_subset_tables.R")
